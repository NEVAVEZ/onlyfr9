...
local Esp = Library:Tab("Esp","rbxassetid://11446965348")

local Misc = Library:Tab("Misc","rbxassetid://11447063791")


Main:Toggle("Aimbot", Settings.Aimbot.Enabled, function(State)
    Settings.Aimbot.Enabled = State
end)

 
 local HitPart = {"HumanoidRootPart","Head","UpperTorso","LowerTorso","Random"}

Main:Dropdown("HitPart", HitPart, function(String)
...
Main:Toggle("FreeForAll", Settings.Aimbot.FreeForAll, function(State)
    Settings.Aimbot.FreeForAll = State
    Settings.T.TeamCheck = Settings.Aimbot.FreeForAll
end)

Main:Toggle("TriggerBot", Settings.T.Enabled, function(State)
    Settings.T.Enabled = State
end)

Main:Toggle("WallCheck", nil, function(State)
    Settings.Aimbot.WallCheck = State
end)

Main:Slider("Aimbot Radius", 0,1000,Settings.Aimbot.FOV,false, function(Value)
    Settings.Aimbot.FOV = Value
    Circle.Radius = Settings.Aimbot.FOV 
end)

 
Main:Toggle("Circle Visible", Settings.Visible, function(State)
...
Main:Toggle("SilentAim", Settings.SilentAim, function(State)
